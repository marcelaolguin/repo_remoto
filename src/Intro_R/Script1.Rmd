...
labnorm<-rnorm(200,0.1,0.13)
fernorm<-rnorm(200,0.9,0.13)
comnorm<-rnorm(200,0.5,0.13)

practica1<-("composta")
factor1<-rep(practica1,each=200)
composta1<-data.frame(factor1, comnorm)

practica2<-("fertilizacion")
factor2<-rep(practica2,each=200)
fertilizacion2<-data.frame(factor2, fernorm)

practica3<-("laboreo")
factor3<-rep(practica3,each=200)
laboreo3<-data.frame(factor,labnorm)

practica4<-cbind(composta1,fertilizacion2, laboreo3)
practica4

pract<-c("composta","fertilizacion","laboreo")
pract 

ejercicio1<-c("composta","fertilizacion","laboreo")
tabla600<-rep(ejercicio1,each=200)

tabla600xC<-data.frame(tabla600)